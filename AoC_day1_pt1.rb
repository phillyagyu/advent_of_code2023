...
#thats the string I got from the challenge
...
#iterates the whole array, after separating each line
for i in 0..input.split.length - 1 do
  ...
  last_index = word.length - 1
	...
	#looping to find first number
  while !numeric?(word[first_index]) && first_index < word.length do
 		first_index = first_index + 1;
	end
  s1 = word[first_index]
	
  #looping to find last number
  while !numeric?(word[last_index]) && last_index > -1 do
